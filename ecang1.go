...
func eccang() {
	...
	err := chromedp.Run(ctx,
		...
		chromedp.Navigate("https://home.eccang.com/entry/EZUKPA/ERP/iframe#/m_45677"),
		chromedp.Sleep(time.Second*5),
		info1(),
		chromedp.Click(`#search-module-baseSearch input[type="button"][value="搜索"].baseBtn.submitToSearch`),
		chromedp.Sleep(time.Second*5),
		chromedp.Click(`#fix_header_content input[type="button"][value="导出库存"].baseBtn.exportProductInventory.authBthClazz.new_inventoryexportBtnClazz.authBthClazzShow`),
		chromedp.Sleep(time.Second*3),
		...
		chromedp.Click(`body > div:nth-child(37) > div.ui-dialog-buttonpane.ui-widget-content.ui-helper-clearfix > div > button:nth-child(1) > span`),
